...
const messages: Record<Locale, Record<string, string>> = {
    'zh-CN': {
        ...
        'importExport.targetUrlPlaceholder': '例如：https://example.com/dav/QuickTab/backup.json',
        ...
        'importExport.webdavHint2': '也可填写基础 URL，系统将自动创建 QuickTabNavigator/backup.json',
    ...
    'en': {
        ...
        'importExport.targetUrlPlaceholder': 'e.g., https://example.com/dav/QuickTab/backup.json',
        ...
        'importExport.webdavHint2': 'Or enter a base URL; the system will auto-create QuickTabNavigator/backup.json',
